...
namespace WebGreenhouse.Areas.Admin.Controllers
{
    public class CustomersController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,UserName,PassWord,CustomerName,CustomerAddress,CustomerWork,Description,Status,CustomerEmail,NumberPhone,CreateDate,Avata,LinkZalo,LinkFacebook")] Customer customer)
        {
